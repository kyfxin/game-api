...
import com.zhexinit.gameapi.misc.BcryptTestEntry;
import com.zhexinit.gameapi.misc.RepeatRule;
...
//        System.out.println("######" + hash);
        ...
        String bcryptHashData = "$2y$10$tJx7iM2Nk8UaDveNwU4X1.BNlzj0XbHO/r/3/Z9nGL75OSMhmB0Ne";
//        BCrypt.Result result1 = BCrypt.verifyer(BCrypt.Version.VERSION_2Y).verify(password.toCharArray(), bcryptHashData);
        BCrypt.Result result1 = BCrypt.verifyer().verify(password.toCharArray(), bcryptHashData);
        boolean verified = result1.verified;
        System.out.println("*******verified=" + verified);
        
        
        String hash = BCrypt.with(BCrypt.Version.VERSION_2Y).hashToString(10, password.toCharArray());
        System.out.println("hash=" + hash);
        BCrypt.Result result2 = BCrypt.verifyer().verify(password.toCharArray(), hash);
        boolean verified2 = result2.verified;
...
//        String springSecurityEncrypt = encoder.encode(password);
//        System.out.println("******springSecurityEncrypt=" + springSecurityEncrypt);
////        boolean springValifyRlt =  encoder.matches(bcryptHashData, springSecurityEncrypt);
////        boolean springValifyRlt =  encoder.matches("123456", springSecurityEncrypt);
//        boolean springValifyRlt =  encoder.matches("123456", hash);
//        System.out.println("******springValifyRlt=" + springValifyRlt);
        
        
        //PHP
        //$2y$10$tJx7iM2Nk8UaDveNwU4X1.BNlzj0XbHO/r/3/Z9nGL75OSMhmB0Ne
        
        //$2y$10$h7v0rRUgEVpkLEPVVp9y7OUnUia13g9IL7zuaFjs7tDsDuAHzz5jK
        //$2y$10$bQu1PBTMTVNvYymhH3iz/u1LPO/uSyCmSinH3ABTXVNqlXntPWFoq
        //$2y$10$sA1NpRbfQgUS00CBJ4w3IOxD/K2I5S3Va1LY.PRSP8Gko8cKlvQEq
